...
import 'package:flutter/cupertino.dart'; // Import Cupertino for debug printing


class OnboardingScreen extends StatefulWidget {
  final Box<UserProfile> settingsBox; // ADDED: settingsBox parameter
  final Box onboardingBox; // ADDED: onboardingBox parameter
  const OnboardingScreen({super.key, required this.settingsBox, required this.onboardingBox}); // MODIFIED constructor
                ...
                isLastPage
                    ? TextButton(
                        onPressed: () async {
                          ...
                          final onboardingBox = widget.onboardingBox; // Access onboardingBox using widget.
                          ...
                          // 4. Save onboarding status
                          try {
                            await onboardingBox.put('hasSeenOnboarding', true);
                            print('Onboarding status saved to onboardingBox');
                          } catch (e) {
                            print('Error saving onboarding status: $e'); // Error handling for put
                          }
