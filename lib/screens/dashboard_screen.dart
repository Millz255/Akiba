...
class _DashboardScreenState extends State<DashboardScreen> {
 ...
 @override
  ...
  void dispose() {
    super.dispose();
    // No timers or streams to cancel in this example, but good practice to include dispose
  }
  ...
  return _buildCard(
    ...
    onVisibilityToggle: _authenticate, // Assuming _authenticate handles balance visibility
  );
}
...
Widget _buildCard({
  ...
  return LayoutBuilder(
    builder: (context, constraints) {
      // Use a fraction of the screen width, but with a maximum
      double maxWidth = constraints.maxWidth;
      double cardWidth = maxWidth > 600 ? 300 : maxWidth * 0.45; // Adjust 300 and 0.45 as needed
      double fontSize = maxWidth > 600 ? 18 : maxWidth * 0.04; // Adjust 16 and 0.04 as needed
                  ...
                  titlesData: FlTitlesData(
                    ...
                    topTitles: AxisTitles(
                      sideTitles: SideTitles(
                        showTitles: true,
                        reservedSize: 18, // Adjust this value if needed
